...
def get_user_body(first_name):
    ...
    current_body = data.user_body.copy() #cuerpo actual es una copia del user body en data
...
def positive_assert(first_name):
    ...
    # String que debe estar en el cuerpo de respuesta, la estructura del body.
